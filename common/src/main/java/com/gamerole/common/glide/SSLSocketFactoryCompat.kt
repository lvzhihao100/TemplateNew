        ...
        init {
            try {
                ...
                if (socket != null) {
                    ...
                    for (protocol in socket.getSupportedProtocols()) if (!protocol.toUpperCase()
                            .contains("SSL")
                    ) protocols.add(protocol)
                    Companion.protocols = protocols.toTypedArray<String>()
                     ...
                     * ciphers should be a server-side task */
                        ...
                        val enabledCiphers: HashSet<String> =
                            preferredCiphers
                        ...
                        cipherSuites =
                            enabledCiphers.toTypedArray<String>()
                    }
                }
            } catch (e: IOException) {
